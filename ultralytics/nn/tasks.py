...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 ...
                 ConvNormLayer, SPDConv,C2PSA, C3k2, MSEFM):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (DySnakeConv,):
                c2 = c2 * 3
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2PSA, C3k2,A2C2f,
                     C3_AKConv,MSEFM):
            ...
            c2 = m.channel
                   ...
                   DySample, CARAFE, ELA, CAA, LocalWindowAttention, EfficientAdditiveAttnetion, AFGCAttention
