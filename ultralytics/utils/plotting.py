...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('FF6B6B', '4ECDC4', '45B7D1', '96CEB4', 'FFEAA7', 
...
def plot_labels(boxes, cls, names=(), save_dir=Path(''), on_plot=None):
    ...
    # 2. 宽高散点图
    sn.histplot(x, x='width', y='height', ax=ax[1], bins=50, pmax=0.9, cmap='rainbow')
    # ax[1].set_title('Width vs Height Distribution')
    # # Seaborn correlogram
